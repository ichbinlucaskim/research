# Experiment: Aggregation Reliability

Experiment Group: 3
Status: Designed
Started: —
Completed: —
Related papers: Reliable Decision-Making for Multi-Agent LLM Systems, Self-Consistency
Related projects: bug-triage-team, agent-execution-viewer, guard-critic-agent
...
- Tool set (if applicable):
- Evaluation judge (if applicable):
- Hardware:
- Random seed:
