# Experiment: Rag Comparison

Experiment Group: 2
Status: Designed
Started: —
Completed: —
Related papers: Retrieval-Augmented Generation (Lewis et al., 2020)
Related projects: research-operator-v0, planner-researcher-writer, personal-note-rag, task-memory-agent
